...
public class SinglyLinkedList<T> {
  ...
  public static void main(String[] args) {
    ...
    Persona persona1 = new Persona("Gonzalo", 31);
    Persona persona2 = new Persona("Juan", 2);
    Persona persona3 = new Persona("María", 4);

    // Linked list simple
    SinglyLinkedList<Persona> sll = new SinglyLinkedList<>();
    sll.addLast(persona1);
    sll.addLast(persona2);
    sll.addLast(persona3);
