...
class Auto extends Vehiculo implements Ventas {
  ...
  public String toString() {
    ...
    public double calcularPrecioVenta(double precioBase, int anioActual) {
        // Calculo de depreciación por años
        int aniosDeUso = anioActual - this.modelo;
        double depreciacion = aniosDeUso * 0.05; // 5% por año para autos
    
        // Calculo del porcentaje adicional según cantidad de puertas
        ...
        porcentajePuertas = 0.35; // Valor por defecto para otras cantidades
        }
